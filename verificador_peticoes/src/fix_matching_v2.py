#!/usr/bin/env python3
"""
Fix para o matching de identificadores - versão corrigida v2
Testa TODOS os _x_x_ que existem no nome do PDF
"""
import re
...
def testar_todos_ids(nome: str, alvo: str) -> bool:
    """Testa se algum dos _x_x_ no nome corresponde ao alvo"""
    try:
        # Encontra TODOS os padrões _x_x_ no nome
